//! Repro for finalizer/cleaner ordering across an owned borrowing return.
//! Enabled for the GC-hosted backends under test: dotnet, kotlin, js.

#[diplomat::bridge]
pub mod ffi {
    #[diplomat::attr(not(any(dotnet, kotlin, js)), disable)]
    #[diplomat::opaque]
